...
<head>
    ...
    <title>Media | Corporate Governance Series</title>
...
<body>
    ...
    <main>
        <section class="page-header">
            <div class="container">
                <h1>Media</h1>
                <p class="page-subtitle">Proof of work. Highlights of the conversations shaping governance outcomes.</p>
            </div>
        </section>
        ...
        <section class="section content-section">
            <div class="container">
                <div class="card-grid" style="grid-template-columns: repeat(3, 1fr); gap: 2rem;">
                    ...
                    <a href="pictures.php" style="text-decoration: none;">
                        <div class="card" style="height: 100%; padding: 3rem; text-align: center;">
                            <h2 style="font-size: 2.5rem; margin-bottom: 1.5rem; color: var(--primary-navy);">Pictures</h2>
                            <p style="font-size: 1.2rem; color: var(--text-charcoal); line-height: 1.8; margin-bottom: 2rem;">
                                Event albums with high-resolution images from CGS sessions. Capturing the dialogue, networking, and moments that shape governance in Africa.
                            </p>
                            <div style="color: var(--accent-gold); font-weight: 600; font-size: 1.1rem;">View Gallery →</div>
                        </div>
                    </a>
                    <a href="blog.php" style="text-decoration: none;">
                        <div class="card" style="height: 100%; padding: 3rem; text-align: center;">
                            <h2 style="font-size: 2.5rem; margin-bottom: 1.5rem; color: var(--primary-navy);">Blog</h2>
                            <p style="font-size: 1.2rem; color: var(--text-charcoal); line-height: 1.8; margin-bottom: 2rem;">
                                Executive summaries first. Deep-dive analysis when it matters. Insights, perspectives, and thought leadership on corporate governance in Africa.
                            </p>
                            <div style="color: var(--accent-gold); font-weight: 600; font-size: 1.1rem;">Read Blog →</div>
                        </div>
                    </a>
                </div>
            </div>
