...
<head>
    ...
    <title>Events | Corporate Governance Series</title>
...
<body>
    ...
    <main>
        <section class="page-header">
            <div class="container">
                <h1>Events</h1>
                <p class="page-subtitle">Where Africa's governance stakeholders align on what good looks like.</p>
            </div>
        </section>
            ...
            <div class="container">
                <div class="card-grid" style="grid-template-columns: 1fr 1fr; gap: 3rem;">
                    ...
                    <a href="series-diary.php" style="text-decoration: none;">
                        <div class="card" style="height: 100%; text-align: center; padding: 3rem;">
                            <h2 style="font-size: 2.5rem; margin-bottom: 1.5rem; color: var(--primary-navy);">Series Diary</h2>
                            <p style="font-size: 1.2rem; color: var(--text-charcoal); line-height: 1.8; margin-bottom: 2rem;">
                                Flagship sessions and stakeholder convenings. Each session produces practical outcomes and follow-through.
                            </p>
                            <div style="color: var(--accent-gold); font-weight: 600; font-size: 1.1rem;">View Series →</div>
                        </div>
                    </a>
                </div>
            </div>
