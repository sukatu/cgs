...
<head>
    ...
    <title>Contact | Corporate Governance Series</title>
...
<body>
    ...
    <main>
        <section class="page-header">
            <div class="container">
                <h1>Contact CGS</h1>
                <p class="page-subtitle">Partnerships, speaking opportunities, training requests, and general enquiries.</p>
            </div>
        </section>
        ...
        <section class="section content-section">
            <div class="container">
                <div class="two-column-large">
                    <div>
                        <h2 style="font-size: 2.25rem; margin-bottom: 1.5rem;">Get in Touch</h2>
                        <p style="font-size: 1.1rem; color: var(--text-charcoal); line-height: 1.8; margin-bottom: 2rem;">
                            Whether you're interested in partnerships, speaking opportunities, training programs, or have general questions about CGS, we'd love to hear from you.
                        </p>
                        <div style="margin-bottom: 2rem;">
                            <h3 style="font-size: 1.5rem; margin-bottom: 1.5rem; color: var(--primary-navy);">Contact Information</h3>
                            ...
                            <div style="margin-bottom: 2rem;">
                                <h4 style="font-size: 1.2rem; margin-bottom: 0.75rem; color: var(--primary-navy); font-weight: 600;">Kumasi Branch</h4>
                                <p style="line-height: 1.8; color: var(--text-charcoal); margin-bottom: 0.5rem;">
                                    Plot 32, Block IV, F.A Jantuah Avenue<br>
                                    Yaa Asantewaa Road, Asokwa-Kumasi
                                </p>
                            </div>
                            ...
                            <div style="margin-bottom: 2rem;">
                                ...
                                <p style="line-height: 2; margin-top: 1rem;">
                                    ...
                                    <a href="tel:+233201108331" style="color: var(--accent-gold); text-decoration: none; font-size: 1.05rem;">+233 20 110 8331</a><br>
                                    <a href="tel:+233506325541" style="color: var(--accent-gold); text-decoration: none; font-size: 1.05rem;">+233 50 632 5541</a>
                                </p>
                            </div>

                            <div style="background-color: var(--bg-offwhite); padding: 1.5rem; border-radius: 8px; border-left: 4px solid var(--accent-gold);">
                                <h4 style="font-size: 1.2rem; margin-bottom: 0.75rem; color: var(--primary-navy); font-weight: 600;">Business Hours</h4>
                                <p style="line-height: 1.8; color: var(--text-charcoal); margin: 0;">
                                    <strong>Mon - Fri:</strong> 9AM - 6PM
                                </p>
                            </div>
                        </div>
                        <div>
                            <h3 style="font-size: 1.5rem; margin-bottom: 1rem; color: var(--primary-navy);">Connect With Us</h3>
                    ...
                    <div>
                        <div class="card" style="padding: 2.5rem;">
                            <h3 style="font-size: 1.75rem; margin-bottom: 1.5rem; color: var(--primary-navy);">Send a Message</h3>
                            <form id="contactForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="contactSubject" name="subject" required>
                                        ...
                                        <option value="network">Network Membership</option>
        ...
        <section class="section content-section-alt">
            <div class="container">
                ...
                <div style="max-width: 800px; margin: 0 auto;">
                    <div style="margin-bottom: 2rem;">
                        <h3 style="font-size: 1.5rem; margin-bottom: 0.75rem; color: var(--primary-navy);">How do I join the CGS Network?</h3>
                        <p style="color: var(--text-charcoal); line-height: 1.7;">
                            Visit our <a href="network.php" style="color: var(--accent-gold); font-weight: 600;">Network page</a> to create an account. Membership is open to directors, lawyers, bankers, regulators, scholars, and governance professionals interested in advancing governance in Africa.
                        </p>
                    </div>
                    <div style="margin-bottom: 2rem;">
                    ...
                    <div>
                        <h3 style="font-size: 1.5rem; margin-bottom: 0.75rem; color: var(--primary-navy);">Can I contribute to the CGS Blog?</h3>
                        <p style="color: var(--text-charcoal); line-height: 1.7;">
                            We welcome contributions from governance professionals. Please contact us using the form above with your article idea and brief author bio. Network members are especially encouraged to contribute.
                        </p>
                    </div>
                </div>
            </div>
