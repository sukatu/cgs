...
<head>
    ...
    <title>CGS Blog | Corporate Governance Series</title>
...
<body>
    ...
    <main>
        ...
        <section class="page-header">
            <div class="container">
                <h1>CGS Blog</h1>
                <p class="page-subtitle">Executive summaries first. Deep-dive analysis when it matters.</p>
            </div>
        </section>
        ...
        <section class="section content-section">
            <div class="container">
                <!-- <div style="display: flex; gap: 1rem; flex-wrap: wrap; margin-bottom: 3rem;">
                    <button class="btn btn-outline" style="padding: 0.625rem 1.25rem; font-size: 0.9rem;">All Topics</button>
                    <button class="btn btn-outline" style="padding: 0.625rem 1.25rem; font-size: 0.9rem;">Board Effectiveness</button>
                    <button class="btn btn-outline" style="padding: 0.625rem 1.25rem; font-size: 0.9rem;">Compliance</button>
                    <button class="btn btn-outline" style="padding: 0.625rem 1.25rem; font-size: 0.9rem;">ESG</button>
                    <button class="btn btn-outline" style="padding: 0.625rem 1.25rem; font-size: 0.9rem;">Risk</button>
                    <button class="btn btn-outline" style="padding: 0.625rem 1.25rem; font-size: 0.9rem;">Digital</button>
                    <button class="btn btn-outline" style="padding: 0.625rem 1.25rem; font-size: 0.9rem;">Ghana</button>
                </div> -->
                ...
                <div class="updates-grid">
                    <article class="update-card" onclick="if(event.target.tagName !== 'A') window.location.href='blog-esg-ghana-perspective.php'" style="cursor: pointer;">
                        <div class="update-content">
                            ...
                            <p><strong>Executive Summary:</strong> Understanding how Environmental, Social, and Governance factors integrate into Ghana's legal framework and why implementing ESG is crucial for sustainable business success in the Ghanaian context. While Ghana's laws may not explicitly mention ESG, the underlying principles are embedded within the country's legal framework.</p>
                            <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 1.5rem; padding-top: 1rem; border-top: 1px solid var(--divider-grey);">
                                <div style="font-size: 0.9rem; color: var(--text-charcoal);">
                                    <strong>Author:</strong> CGS Research Team<br>
                    ...
                    <article class="update-card" onclick="if(event.target.tagName !== 'A') window.location.href='blog-principles-rules-africa.php'" style="cursor: pointer;">
                        <div class="update-content">
                            ...
                            <p><strong>Executive Summary:</strong> Research from Nigeria suggests African countries need an integrated approach combining rule-based and principle-based regulation, supported by multi-stakeholder co-regulation. This challenges the assumption that developed economy regulatory models can be directly transplanted to African contexts.</p>
                            <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 1.5rem; padding-top: 1rem; border-top: 1px solid var(--divider-grey);">
                                <div style="font-size: 0.9rem; color: var(--text-charcoal);">
                                    <strong>Author:</strong> CGS Research Team<br>
                    ...
                    <article class="update-card" onclick="if(event.target.tagName !== 'A') window.location.href='blog-soes-ghana.php'" style="cursor: pointer;">
                        <div class="update-content">
                            ...
                            <p><strong>Executive Summary:</strong> Research reveals that governance mechanisms alone don't directly improve SOE performance—they need to interact with other factors to create meaningful change. The study highlights that most SOEs in Ghana are not primarily profit-oriented, requiring different performance measures.</p>
                            <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 1.5rem; padding-top: 1rem; border-top: 1px solid var(--divider-grey);">
                                <div style="font-size: 0.9rem; color: var(--text-charcoal);">
                                    <strong>Author:</strong> CGS Research Team<br>
                                    <strong>Read Time:</strong> 10 min
                    ...
                    <article class="update-card" onclick="if(event.target.tagName !== 'A') window.location.href='blog-agency-costs-ghana.php'" style="cursor: pointer;">
                        <div class="update-content">
                            ...
                            <p><strong>Executive Summary:</strong> Research examining Ghanaian companies reveals that smaller boards, audit committees, and higher ownership stakes effectively reduce agency costs. However, separating CEO and chair roles, and having more non-executive directors, showed no significant impact—challenging conventional governance wisdom.</p>
                            <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 1.5rem; padding-top: 1rem; border-top: 1px solid var(--divider-grey);">
                                <div style="font-size: 0.9rem; color: var(--text-charcoal);">
                                    <strong>Author:</strong> CGS Research Team<br>
                                    <strong>Read Time:</strong> 10 min
